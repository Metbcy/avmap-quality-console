  ...
  return (
    <div className="flex h-12 items-center justify-between border-b border-gray-800 bg-gray-950 px-4">
      ...
      <nav className="flex gap-1 text-xs">
        <Link href="/" className={`rounded px-2.5 py-1 ${active === "triage" ? "bg-gray-800 text-indigo-300" : "text-gray-400 hover:text-gray-200"}`}>Triage</Link>
        <Link href="/diff" className={`rounded px-2.5 py-1 ${active === "diff" ? "bg-gray-800 text-indigo-300" : "text-gray-400 hover:text-gray-200"}`}>Diff</Link>
      </nav>
    </div>
  );
}
